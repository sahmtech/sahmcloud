            ...
            foreach($taxPercentages as $taxPercentage) {
                ...
                if(count($taxableItems) > 0) {
                    $taxCategoryGroups[] = [
                        ...
                        'tax_exemption_code' => $taxableItems[0]->tax_exemption_code ?? config("zatca.exemptions.$taxCategoryCode.code"),
                        'tax_exemption_reason' => $taxableItems[0]->tax_exemption_reason ?? config("zatca.exemptions.$taxCategoryCode.reason"),
