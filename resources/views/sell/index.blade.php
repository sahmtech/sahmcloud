...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        columns: [
            ...
            { data: 'types_of_service_name', name: 'tos.name', @if(empty($is_types_service_enabled)) visible: false, @endif visible: false},
            { data: 'service_custom_field_1', name: 'service_custom_field_1', @if(empty($is_types_service_enabled)) visible: false, @endif visible: false},
            { data: 'custom_field_1', name: 'transactions.custom_field_1', @if(empty($custom_labels['sell']['custom_field_1'])) visible: false, @endif visible: false},
            { data: 'custom_field_2', name: 'transactions.custom_field_2', @if(empty($custom_labels['sell']['custom_field_2'])) visible: false, @endif visible: false},
            { data: 'custom_field_3', name: 'transactions.custom_field_3', @if(empty($custom_labels['sell']['custom_field_3'])) visible: false, @endif visible: false},
            { data: 'custom_field_4', name: 'transactions.custom_field_4', @if(empty($custom_labels['sell']['custom_field_4'])) visible: false, @endif visible: false},
            ...
            { data: 'table_name', name: 'tables.name', @if(empty($is_tables_enabled)) visible: false, @endif visible: false },
            { data: 'waiter', name: 'ss.first_name', @if(empty($is_service_staff_enabled)) visible: false, @endif visible: false },
        ],
