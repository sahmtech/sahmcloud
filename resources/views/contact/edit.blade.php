        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div id="more_div" class="hide">
                    ...
                    <hr>
                    <div class="col-md-12">
                        <h4>@lang('zatca.zatca_information_section')</h4>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('buyer_name', __('zatca.buyer_registration_name') . ':') !!}
                            {!! Form::text('buyer_registration_name', $contact->registration_name, [
                                'class' => 'form-control',
                                'placeholder' => __('zatca.buyer_registration_name'),
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('buyer_street', __('zatca.buyer_street') . ':') !!}
                            {!! Form::text('buyer_street', $contact->street_name, [
                                'class' => 'form-control',
                                'placeholder' => __('zatca.buyer_street'),
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('buyer_building_number', __('zatca.buyer_building_number') . ':') !!}
                            {!! Form::text('buyer_building_number', $contact->building_number, [
                                'class' => 'form-control',
                                'placeholder' => __('zatca.buyer_building_number'),
                            ]) !!}
                        </div>
                    </div>
