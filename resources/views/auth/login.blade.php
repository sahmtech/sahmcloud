...
@section('content')
    <div class="col-sm-12 col-xs-12 col-md-10">
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form" style="padding-top: 20px;">
            {{ csrf_field() }}
            <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
                ...
                padding: 5px;" value="{{ $username }}" required autofocus
            ...
            <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
                <input id="password" type="password" class="form-control" name="password"
                    style="border-radius: 5px;
                padding: 5px;" value="{{ $password }}" required
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-flat btn-login"
                    style="width: 100%;
                border-radius: 5px;    background-color: #333d81;">@lang('lang_v1.login')</button>
