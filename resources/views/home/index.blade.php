...
@section('content')
    ...
    <section class="content-header content-header-custom">
        ...
        <h1>@lang('home.Custom_welcome_message') {{ Session::get('user.first_name') }}</h1>
            ...
            @if ($is_admin)
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style" >
                            <span class="info-box-icon bg-aqua"
                                style="background-image: linear-gradient(to right,#2becdc,#0f8393);"><i
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            <span class="info-box-icon bg-green"
                                style="background-image: linear-gradient(to right,#83d63e,#0e8f3f);">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            <span class="info-box-icon bg-yellow"
                                style="background-image: linear-gradient(to right,#e9ab39,#ff7503);">
                                <i class="ion ion-ios-paper-outline"></i>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            <span class="info-box-icon bg-red text-white"
                                style="background-image: linear-gradient(to right,#e2499d,#ff0357);">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            <span
                                class="info-box-icon bg-yellow"style="background-image: linear-gradient(to right,#e9ab39,#ff7503);">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number total_expense"
                                    ><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            <span class="info-box-icon bg-red text-white" style="background-image: linear-gradient(to right,#e2499d,#ff0357);">
