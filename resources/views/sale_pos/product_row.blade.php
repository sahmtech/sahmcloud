...
<tr class="product_row" data-row_index="{{ $row_count }}"
    ...
    <td>
        ...
        <div class="input-group input-number">
            ...
            <input type="text" data-min="1" style="width:64px;"
    ...
    <td class="text-center v-center"style="    font-size: x-small;border: none;
 color: #c90000;">
        <i class="fa fa-trash fa-2x  pos_remove_row cursor-pointer" aria-hidden="true"></i>
    </td>
</tr>
