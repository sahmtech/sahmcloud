...
<style>
	...
	.table-slim, .table-slim td, .table-slim th {
...
<div class="row" style="color: #000000 !important;">
    <div class="col-xs-12">
        ...
        <table class="table table-responsive table-slim table-bordered">
            <thead>
                <tr>
                    <th class="text-end custom-bg" style="vertical-align: top;" width="{{ $p_width }}%">
                    ...
                    @if (!empty($receipt_details->discounted_unit_price_label))
                        <th class="text-end custom-bg" style="vertical-align: top;" width="10%">
            ...
            <tbody>
                @forelse($receipt_details->lines as $line)
                    <tr>
                        ...
                        <td class="text-end">{{ $line['unit_price_before_discount'] }}</td>
                        @if (!empty($receipt_details->discounted_unit_price_label))
                            <td class="text-end">
                    ...
                    @if (!empty($line['modifiers']))
                        @foreach ($line['modifiers'] as $modifier)
                            <tr>
                                ...
                                <td class="text-end">{{ $modifier['quantity'] }} {{ $modifier['units'] }} </td>
                                <td class="text-end">{{ $modifier['unit_price_inc_tax'] }}</td>
                                @if (!empty($receipt_details->discounted_unit_price_label))
                                    <td class="text-end">{{ $modifier['unit_price_exc_tax'] }}</td>
                                @endif
                                @if (!empty($receipt_details->item_discount_label))
    ...
    <div class="border-bottom col-md-12">
        @if (empty($receipt_details->hide_price) && !empty($receipt_details->tax_summary_label))
            ...
            @if (!empty($receipt_details->taxes))
                <table class="table table-slim table-bordered">
                    <tr>
                        <th colspan="2" class="text-center custom-bg">{{ $receipt_details->tax_summary_label }}</th>
                    </tr>
