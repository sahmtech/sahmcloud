@forelse($products as $product)
    <div class="col-md-3 col-xs-4 product_list no-print">
        <div class="product_box"
            style="border-radius: 6px;box-shadow: 1px 0px 8px rgba(0, 0, 0, 0.5);border-bottom: 2px solid #5a4f91; padding: 10px 0px;padding-top: 0px;"
			...
			background-size: contain;height: 93px;width:100%;background-size: cover;border-radius: 6px 6px 0px 0px;">
