...
<div class="col-md-12 no-print pos-header">
    ...
    <div class="row" style="margin: 7px 0px;">
        <div class="col-md-6">
            <div class="m-6 mt-5" style="display: flex;gap: 10px;
            align-items: center;">
                <p style="margin:  11px 0px;"><strong>@lang('sale.location'): &nbsp;</strong>
        ...
        <div class="col-md-6 pos_controll">
            <a href="{{ $go_back_url }}"
                style="    justify-content: center;
            align-items: center;
            display: flex;"
                title="{{ __('lang_v1.go_back') }}" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
        ...
        font-size: small;"
                    title="{{ __('expense.add_expense') }}" data-placement="bottom"
